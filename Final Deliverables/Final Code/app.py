...
def connection():
    try:
        conn = ibm_db.connect("DATABASE=bludb;HOSTNAME=1bbf73c5-d84a-4bb0-85b9-ab1a4348f4a4.c3n41cmd0nqnrk39u98g.databases.appdomain.cloud;\
            PORT=32286;PROTOCOL=TCPIP;UID=cyp26260;PWD=2u8Lfagovgh630DH;SECURITY=SSL;SSLServiceCertificate=DigiCertGlobalRootCA.crt", "", "")
        print("Connected to Database")
        return conn
    except:
        print("Not Connected to Databased")
